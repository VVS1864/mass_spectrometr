...
public class Graph_energy extends Graph_canvas{
	...
	public Graph_energy(ArrayList<Integer> x_data, ArrayList<Integer> y_data, String x_measure, String y_measure, Chart_analyser analyser) {
...
// Data rendering
    	...
    	if (x_data_int.size() == 0 || y_data.size() == 0) return;
    	
    	/*
    	xx = new int[x_data_int.size()];
    	yy = new int[y_data.size()];
    	*/
